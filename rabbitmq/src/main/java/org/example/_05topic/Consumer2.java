...
public class Consumer2 {
    ...
    private static final String KEY1 = "user.create.*";
    private static final String KEY2 = "user.#.name";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        try {
            ...
            DeliverCallback deliver = (consumerTag, message) -> {
                System.out.println("user.create.*/user.#.name:" + new String(message.getBody()));
                //手动应答。
